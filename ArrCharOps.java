...
public class ArrCharOps {
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        ...
        System.arraycopy(arr1, 0, result, 0, arr1.length); // Copy arr1 into result
        System.arraycopy(arr2, 0, result, arr1.length, arr2.length); // Copy arr2 into result
        return result;
    }
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        ...
        System.arraycopy(arr, beginIndex, subArray, 0, endIndex - beginIndex);
        return subArray;
    }
    ...
    public static long hashCode(char[] arr) {
        long hashCode = 0;
        for (int i = 0; i < arr.length; i++) {
            hashCode += arr[i] * Math.pow(7, arr.length - 1 - i); // Applying the given formula
        }
        return hashCode;
    }
    ...
    public static int compareTo(String str1, String str2) {
        ...
        for (int i = 0; i < minLength; i++) {
            ...
            if (comparison != 0) {
                return comparison; // Return negative if str1 is smaller, positive if greater
            }
        }
